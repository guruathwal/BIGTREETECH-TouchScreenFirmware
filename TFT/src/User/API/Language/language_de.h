...
#define _LANGUAGE_DE_H_
    ...
    #define DE_UNIFIEDHEAT          "Heizen&Lüfter"
    ...
    #define DE_MOVE_SPEED           "Bewegungsgeschwindigkeit (X Y Z)"
    #define DE_KNOB_LED             "Drehknopf LED"
    #define DE_M0_PAUSE             "Pause durch M0 kommando"
    #define DE_SEND_START_GCODE     "Start-Gcode vor dem druck"
    #define DE_SEND_END_GCODE       "End-Gcode nach dem druck"
    #define DE_PERSISTANT_STATUS_INFO "Speicherungs-status Information"
    #define DE_FILE_LISTMODE        "Dateiansicht in Liste"
